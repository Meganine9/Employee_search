...
function showAllEmployees(){
  ...
  <div class="employee-card">
    ...
    <p>${emp.department}</p>
    <p>${emp.position}</p>
    <p>${emp.primarySkill}</p>
    <p>${emp.salary}</p>
    <p>${emp.yearsOfExperience}</p>
  </div>
    `
...
function showAllEngineering(){
  let eng = employees.filter(e=>e.department="Engineering")
  let grid=document.getElementById('employeesGrid')
  grid.innerHTML += eng.map(emp=> `
  <div class="employee-card">
    <h3>${emp.name}</h3>
    <p>${emp.email}</p>
    <p>${emp.department}</p>
...
function showAllMarketing(){
  let mar=employees.filter(e=>e.department="Marketing")
  let grid=document.getElementById('employeesGrid')
  grid.innerHTML += mar.map(emp=> `
  <div class="employee-card">
    <h3>${emp.name}</h3>
    <p>${emp.email}</p>
    <p>${emp.department}</p>
...
function showAllSales(){
  let sal=employees.filter(e=>e.department="Sales")
  let grid=document.getElementById('employeesGrid')
  grid.innerHTML += sal.map(emp=> `
  <div class="employee-card">
    <h3>${emp.name}</h3>
    <p>${emp.email}</p>
    <p>${emp.department}</p>
